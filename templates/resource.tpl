    ...
    <div class="top-bar-header">
		...
		<div class = "manage-grid">
			...
			<tr style="border-bottom:none;">
				...
				<td width="10%" nowrap="nowrap" style="text-align:right; border-bottom:none;" >Resource Name:</td>
				...
				<td width="10%" nowrap="nowrap" style="text-align:right; border-bottom:none;">Resource Initial:</td>
				<td width="5%" style="border-bottom:none;"><input type ="text" id="rs_ini" name = "resource_initial" style="width: 200px;" value="{$resourceDetails.0.ResourceInitial}" onkeyup ="caps()" ></td>
				
				<!---- Submit Button ---->
				
				<td width="10%" nowrap="nowrap" style="text-align:right;border-bottom:none;"></td>
